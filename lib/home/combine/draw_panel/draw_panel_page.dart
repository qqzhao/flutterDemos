...
import 'package:hello/home/combine/draw_panel/scrawl_painter.dart';
import 'package:oktoast/oktoast.dart';

/// https://blog.csdn.net/yumi0629/article/details/84382293
///
class DrawPanelPage extends StatefulWidget {
  @override
  _DrawPanelPageState createState() => _DrawPanelPageState();
}

class _DrawPanelPageState extends State<DrawPanelPage> {
      ...
      child: StatefulBuilder(builder: (context, state) {
        return Row(
          ...
          children: <Widget>[
            ...
            GestureDetector(
              child: Container(
                color: selectedColor == colors[0] ? Colors.grey.withOpacity(0.2) : Colors.transparent,
                child: Icon(
                  Icons.create,
                  color: colors[0],
                ),
            ...
            GestureDetector(
              child: Container(
                color: selectedColor == colors[1] ? Colors.grey.withOpacity(0.2) : Colors.transparent,
                child: Icon(
                  Icons.create,
                  color: colors[1],
                ),
            ...
            GestureDetector(
              child: Container(
                color: selectedColor == colors[2] ? Colors.grey.withOpacity(0.2) : Colors.transparent,
                child: Icon(
                  Icons.create,
                  color: colors[2],
                ),
