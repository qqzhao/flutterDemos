...
class _TexTest1State extends State<TexTest1> {
  String docText = '<h3>What is the correct <h1>xxx</h1>form of quadratic formula?</h3>';
  String docText2 = """
  ...
  """;
  String docText5 = r""" <h2> \( a_0 = \frac{{\hbar }}{{m_e ke^2 }} \)<div>xxx: \(a_0 = \frac{{bar }}{{m_e ke^2 }} \)</div></h2>""";
  @override
